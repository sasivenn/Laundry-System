...
function AdminNewOrder() {
    ...
    const [isLatefeeDisabled, setIsLatefeeDisabled] = useState(false);
    const [isDeliveryfeeDisabled, setIsDeliveryfeeDisabled] = useState(false);
    const [isServiceCostDisabled, setServiceCostDisabled] = useState(false);
    const [isTotalCostDisabled, setTotalCostDisabled] = useState(false);
					...
					<h1>Place Order</h1>
                        ...
                        <div class="col-12">
                            ...
                            <label> Customer ID</label>
								<input type="text" name="customerid" id="customerid" onChange={(e) => setcustomerId(e.target.value)} />
							</div>
							<div class="col-12">
								<ul class="actions">
